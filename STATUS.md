...
- **API key security**: 4 tests proving raw keys are not stored in the database, hash comparison works, different keys produce different hashes, and config rejects missing API key env.
